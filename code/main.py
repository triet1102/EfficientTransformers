...
from efficient_transformer.utility import save_benchmark_result, load_benchmark_result
...
pb = PerformanceBenchmark(intents=intents, pipeline=pipe, dataset=clinc["test"], optim_type="BERT_baseline",)
print("Launching benchmark")
metrics_res = pb.run_benchmark()
save_benchmark_result(res=metrics_res, file_path=f"results/{pb.optim_type}.pickle")
print(f"Finished")
